...
?>
	<style type="text/css">header#masthead { <?php echo sprintf( "background-image: url('%s');",  $_s_header_image_uri ); ?> background-repeat: no-repeat;  background-position: right bottom; } </style>
<?php
}; 
